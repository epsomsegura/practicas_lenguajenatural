...
if __name__ == "__main__":
    txt_a = text_analysis("./src/corrigeme.txt")
    print('tokens originales: '+str(len(txt_a.getTokens())))
    print('tokens stopwordsReduction: '+str(len(txt_a.stopwordsReduction(txt_a.getTokens()))))
    print('tokens snowballStemmerReduction: '+str(len(txt_a.snowballStemmerReduction(txt_a.stopwordsReduction(txt_a.getTokens())))))
    print('tokens lemmaReduction: '+str(len(txt_a.lemmaReduction(txt_a.stopwordsReduction(txt_a.getTokens())))))
    

    sw = txt_a.frequencyDistribution(txt_a.stopwordsReduction(txt_a.getTokens()))
    txt_a.printFrequencyDistribution(sw)
